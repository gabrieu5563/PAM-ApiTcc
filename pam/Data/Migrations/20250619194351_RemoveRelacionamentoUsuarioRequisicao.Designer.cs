...
namespace pam.Data.Migrations
{
    ...
    [Migration("20250619194351_RemoveRelacionamentoUsuarioRequisicao")]
    partial class RemoveRelacionamentoUsuarioRequisicao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pam.Models.Requisicao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TB_REQUISICAO", (string)null);
                });
            ...
            modelBuilder.Entity("pam.Models.Requisicao", b =>
                {
                    b.HasOne("pam.Models.Usuario", null)
